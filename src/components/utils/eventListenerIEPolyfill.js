 ...
 */
export function eventListenerIEPolyfill(window, document, listeners_prop_name) {
...
if (window && document) {
  ...
  if(__DEV__) {
    console.log('eventListenerPolyfill run');
  }

  eventListenerIEPolyfill(window, document, 'x-ms-event-listeners');
}